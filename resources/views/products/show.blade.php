    ...
    <div class="container py-8">
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="bg-while rounded-lg shadow-lg mb-6">
                ...
                @livewire('add-card-item-size', ['product' => $product])

                @elseif ($product->subcategory->color)

                @livewire('add-card-item-color', ['product' => $product])

                @else

                @livewire('add-card-item', ['product' => $product])
