<div>
    ...
    <div class="grid grid-cols-5 gap-6 container py-8">
        <div class="col-span-3">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 text-gray-700 mb-4">
                <p class="text-xl font-semibold m b-4">Resumen</p>
        ...
        <div class="col-span-2">
            <div class="bg-white rounded-lg shadow-lg px-6 pt-6">
                <div class="flex justify-between items-center mb-6">
                    <img class="h-8" src="{{ asset('img/formas-pago.png') }}" alt="">
