<div>
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="description">
            Complete la informacion necesita para poder crear una categoria
        </x-slot>
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-jet-input disabled wire:model="createForm.slug" type="text" class="w-full mt-1 bg-gray-100"></x-jet-input>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <input wire:model="createForm.image" type="file" class="mt-1" id="{{$rand}}" accept="image/*">
        ...
        <x-slot name="content">
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <x-jet-input disabled wire:model="editForm.slug" type="text" class="w-full mt-1 bg-gray-100"></x-jet-input>
                ...
                <div>
                    ...
                    <x-jet-input-error for="editForm.brands"></x-jet-input-error>
                </div>
                <div>
                    <x-jet-label>
                        Imagen
                    </x-jet-label>
                    <input wire:model="editImage" type="file" class="mt-1" id="{{$rand}}" accept="image/*">
