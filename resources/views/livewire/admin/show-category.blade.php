<div class="container py-12">
    ...
    <x-jet-form-section submit="save" class="mb-6">
        ...
        <x-slot name="description">
            Complete la informacion necesita para poder crear una subcategoria
        </x-slot>
        <x-slot name="form">
            ...
            <div class="space-y-3">
                ...
                <div >
                    <div class="flex items-center">
                        ...
                        <div class="ml-auto">
                            <label>
                                <input wire:model="editForm.color" type="radio" value="1" name="color">
                                Si
                            </label>
                            <label>
                                <input wire:model="editForm.color" type="radio" value="0" name="color">
                                No
                            </label>
                        </div>
                    </div>
